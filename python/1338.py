...
def numOfSquareFree(n, num, primePos):
    if primePos >= 17984:
        return 0
    sq = squaredPrimes[primePos]
    if num <= n//sq:
        ans = n//(num*sq)
        ans += numOfSquareFree(n, num, primePos+1)
        ans -= numOfSquareFree(n, num*sq, primePos+1)
        return ans
    return 0
